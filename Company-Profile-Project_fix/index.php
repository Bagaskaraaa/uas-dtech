...
<body id="home" class="scrollspy">
    ...
    <nav class="purple accent-3">
      <div class="container">
        <div class="nav-wrapper">
          <a href="#home" class="brand-logo">Dtech</a>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col m6 light">
          ...
          <p>kami adalah badan usaha yang bergerak di bidang software, perushaan ini didirikan pada tahun 2021, kami siap membantu anda.</p>
        </div>
        <div class="col m6 light">
          <p>WEB DEVELOPMENT</p>
          <div class="progress">
            <div class="determinate purple accent-3" style="width: 95%"></div>
          </div>
          <p>MOBILE APP DEVELOPMENT</p>
          <div class="progress">
            <div class="determinate purple accent-3" style="width: 90%"></div>
          </div>
          <p>GAME DEVELOPMENT</p>
          <div class="progress">
            <div class="determinate purple accent-3" style="width: 85%"></div>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col m5 s12">
          <div class="card-panel purple accent-3 center white-text">
          ...
          <ul class="collection with-header">
            ...
            <li class="collection-item">Dtech</li>
            <li class="collection-item">Jl. Bendungan Sutami No.188, Sumbersari, Kec. Lowokwaru, Kota Malang, Jawa Timur 65145</li>
            <li class="collection-item">Malang, Indonesia</li>
          </ul>
        </div>
        ...
        <div class="col m7 s12">
          <form>
            <div class="card-panel">
              ...
              <button type="submit" class="btn purple accent-3">Send</button>
            </div>
          </form>
        </div>
      </div>
  ...
  <!-- footer -->
  <footer class="purple accent-3 white-text center">
    <p class="flow-text">Dtech. Copyright 2021.</p>
  </footer>
